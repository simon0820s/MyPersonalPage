...
function MyCode() {
  return (
    <section
      ...
      <div className="flex flex-col gap-4 items-center px-8 bg-zinc-800 rounded-bl-full pt-4">
        <article className="flex flex-col items-end gap-2">
          ...
          <p className="text-end opacity-80">
        ...
        <div className='flex items-center justify-end w-full gap-2'>
          ...
          <a href='https://github.com/simon0820s' target='_blank' rel='noreferrer'
            className='flex gap-1 items-center p-1 text-xs font-bold border-2 border-zinc-400 text-zinc-400 rounded-sm'>
