          ...
          <div className="flex gap-4 pl-2">
            <div className="flex flex-col items-center">
              <motion.span
                ...
                transition={{ duraction: 0.3 }}
                className="w-2 h-2 rounded-full bg-purple-200"></motion.span>
              <motion.span
                initial={{ opacity: 0, y: 80, scale: 0.2 }}
                animate={{ opacity: 1, y: 0, scale: 1 }}
                transition={{ duraction: 0.3 }}
            ...
            <ul className="flex flex-col gap-1 text-xs text-zinc-400">
              ...
              <li>* All of my projects are available at <span className="font-bold text-purple-200 opacity-80">https://github.com/simon0820s</span>
              </li>
              <li>* Ask me about React, Next, ML, Blockchain, MongoDB</li>
              <li>* How to reach me <span className="font-bold text-purple-200 opacity-80">simon0820s@gmail.com</span></li>
            </ul>
          </div>
        </article>
      </div>
